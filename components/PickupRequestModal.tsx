...
// Separate form component to isolate state updates and prevent modal wrapper re-renders
function PickupRequestForm({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      ...
      >
        ...
        <div className="p-6">
          <PickupRequestForm onClose={onClose} />
        </div>
      </motion.div>
    </div>
  );
