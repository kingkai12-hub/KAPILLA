...
`;
        ...
        console.log("✅ .env file updated with the working URL.");
        ...
        if (errString.includes("Tenant or user not found")) {
             console.log("❌ Region mismatch (Tenant not found).");
        } else if (errString.includes("P1001")) {
             console.log("❌ Unreachable (Network/DNS).");
        } else if (errString.includes("P1000")) {
             console.log("❌ Authentication failed (Wrong Password?).");
        } else {
             console.log("❌ Failed: " + errString.substring(0, 50) + "...");
        }
...
if (!success) {
    console.log("\n\x1b[31m%s\x1b[0m", "❌ Could not find a working connection.");
    console.log("Please double-check your password.");
} else {
    console.log("\n\x1b[32m%s\x1b[0m", "🎉 YOU ARE ALL SET! Database is ready.");
}
