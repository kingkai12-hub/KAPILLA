...
export default function InvoicePage() {
  ...
  const fetchInvoices = async () => {
    try {
      const res = await fetch('/api/invoices-new?type=FINAL', { credentials: 'include' });
      if (res.ok) {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage final invoices and billing</p>
        </div>
        <Link
          href="/staff/invoice/create"
