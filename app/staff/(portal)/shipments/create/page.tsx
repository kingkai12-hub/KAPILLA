      ...
      <div className="max-w-3xl mx-auto bg-white dark:bg-slate-900 shadow-lg rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800">
        <div className="bg-green-50 dark:bg-green-900/20 p-5 sm:p-6 border-b border-green-100 dark:border-green-900/40 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="sm:text-right">
            ...
            <span className="block text-2xl sm:text-3xl font-mono font-black text-slate-950 dark:text-white tracking-wider overflow-x-auto whitespace-nowrap">
              {generatedWaybill}
            </span>
          </div>
        </div>
        ...
        <div className="p-5 sm:p-8 space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
            <div>
              ...
              <p className="font-bold text-base sm:text-lg text-slate-950 dark:text-white">
                {formData.senderName}
              </p>
          ...
          <div className="border-t border-slate-200 dark:border-slate-800 pt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p className="font-medium text-slate-950 dark:text-white">
                {formData.weight} kg / {formData.type}
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
            <button
              onClick={() => window.open(`/api/shipments/${generatedWaybill}/pdf`, '_blank')}
    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          Fill the sender, receiver, and package details to generate a waybill.
        </p>
      </div>

      <form
        onSubmit={handleSubmit}
        className="bg-white dark:bg-slate-900 shadow-sm rounded-2xl p-5 sm:p-8 border border-slate-200 dark:border-slate-800"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Sender Section */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white border-b border-slate-200 dark:border-slate-800 pb-2">
              Sender Details
            </h3>
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full border border-slate-300 dark:border-slate-700 rounded-xl shadow-sm py-3 px-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-slate-900 dark:text-white bg-white dark:bg-slate-950"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="mt-4">
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">
              Additional Details / Cargo Description
            </label>
            <textarea
              name="cargoDetails"
              ...
              rows={3}
              className="mt-1 block w-full border border-slate-300 dark:border-slate-700 rounded-xl shadow-sm py-3 px-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-slate-900 dark:text-white bg-white dark:bg-slate-950"
              placeholder="Describe contents, special handling instructions, etc."
            />
          </div>
        </div>
